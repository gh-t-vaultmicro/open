...
void show_usage(){
    ...
    cout << "build) g++ -std=c++11 -o open open1slpc2.cpp `pkg-config --cflags --libs opencv4` " << endl;
    ...
    cout << "If not work, create video, log, picture_frame directory in the current directory" << endl;
    cout << "Press 'q' or 'ctrl + c' for the exit " << endl;
